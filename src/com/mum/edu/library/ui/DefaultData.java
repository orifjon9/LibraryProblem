...
public class DefaultData {
	...
	static {
		Employee nguyenLe = new Employee(123,"handsomeBoy", "Nguyen", "Le", new Address("1000 N 4th", "Fairfield", "Iowa", "52707"), "+1 932 434 444", new HashSet<>(Arrays.asList(ADMINROLE)));
